...
const CUSTOM_OBJ_ID = 'p48454069_books';
...
app.get('/', async (req, res) => {
  const customObjects = `https://api.hubapi.com/crm/v3/objects/${CUSTOM_OBJ_ID}?properties=name,number_of_pages,type`;
  const headers = {
...
app.get('/updatecobj', async (req, res) => {
...
app.post('/updatecobj', async (req, res) => {
  const postBody = {
      properties: {
          "name": req.body.name,
